...
//incluimos el archivo donde se encuentran nuestros datos de conexion
 ...
 WHERE nom_usu = '$_POST[username] ' and  contrasena = '$_POST[password]' ";
 ...
 echo "<a href='index.html'>Por favor escoga otro Nombre</a>";
  ...
  //insertar lo del formulario
 $query = "INSERT INTO clientes ('usuario','contrasena') VALUES ('$_POST[username]', '$form_pass')";
